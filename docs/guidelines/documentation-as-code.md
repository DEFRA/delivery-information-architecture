...
description: Philosophy, benefits, and approach to documentation-as-code at Defra
---
...
See the [Using as a Template](/using-as-a-template) section for detailed setup instructions.
...
1. Check the [homepage](/) for setup instructions
